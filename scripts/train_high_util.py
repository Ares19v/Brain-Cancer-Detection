...
# 1. Config for RTX 5060 Utilization
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
BATCH_SIZE = 128  
# Balanced weights to fix the Meningioma bias
...
loader = DataLoader(
    ...
    shuffle=True, 
    num_workers=4,    # Feeds the GPU using i7 CPU cores
...
print(f"🔥 Starting High-Util Training on {torch.cuda.get_device_name(0)}...")
...
print("\n✅ HIGH-PERFORMANCE MODEL SAVED TO weights/efficientnet_b0.pth")
